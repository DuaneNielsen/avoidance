...
<mujoco model="velocity_control">
  ...
  <actuator>
    ...
    <velocity name="velocity" site="velocity_site" gear="1 0 0 0 0 0" kv="10" ctrlrange="-2 2"/>
    
    <!-- Angular velocity control around Z axis in body frame -->
    <velocity name="angular_velocity" site="rotation_site" gear="0 0 0 0 0 1" kv="10" ctrlrange="-1 1"/>
  </actuator>
</mujoco>
"""
