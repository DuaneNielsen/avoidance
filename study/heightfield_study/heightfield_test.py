"""
Key MuJoCo Rangefinder Insights:

Materials matter: Geoms need materials for proper collision detection
Ray visualization: Only shows hits, not misses (-1 returns)
Site orientation: X-axis determines ray direction
Sensor data: Index 0 for first rangefinder, returns distance or -1
Common failure: Missing materials
Geometry matters: double check your geometry so that sensor rays intersect, or use simple geometry
"""
import numpy as np
import mujoco
